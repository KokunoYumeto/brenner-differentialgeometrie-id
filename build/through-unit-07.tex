...
% Unit 7's frozen MediaWiki TeX uses underscore-normalized PNG names while
% the canonical Commons filenames retain spaces.  The bounded Unit 7 build
% creates exact generated aliases and routes only these PNG macros through
% that generated directory; canonical source files remain untouched.
...
\title{Geometri Diferensial dan Manifold Mulus\\\large Pembaca kumulatif hingga Unit 7}
...
Pembaca kumulatif ini menerjemahkan Kuliah 1--7 dan Lembar Kerja 1--7 dari kursus Holger Brenner di Wikiversity berbahasa Jerman. Teks sumber digunakan berdasarkan CC BY-SA 4.0. Terjemahan ini merupakan karya independen dan bukan edisi resmi atau dukungan dari penulis maupun Wikiversity. Setiap gambar mengikuti status hak atau lisensi berkasnya sendiri, yang dicatat pada daftar gambar dan manifest media.
