...
$qaDir = Join-Path $laneRoot 'qa\unit-05'
$workDir = Join-Path $laneRoot 'tmp\pdfs\through-unit05-build'
$outputDir = Join-Path $laneRoot 'output\pdf'
$outputPdf = Join-Path $outputDir 'geometri-diferensial-manifold-mulus-hingga-unit-05-id.pdf'
...
$translationPairs = @(
    ...
    @{ source = 'lecture05_source.de.tex'; target = 'unit-05\lecture05.id.tex'; receipt = 'unit-05\lecture05_translation.json'; corrections = '00_control\LECTURE05_PROTECTED_CORRECTIONS.json' },
    @{ source = 'worksheet05_source.de.tex'; target = 'unit-05\worksheet05.id.tex'; receipt = 'unit-05\worksheet05_translation.json'; corrections = '00_control\WORKSHEET05_PROTECTED_CORRECTIONS.json' },
    @{ source = 'worksheet05_exercise01_solution_source.de.tex'; target = 'unit-05\worksheet05_exercise01_solution.id.tex'; receipt = 'unit-05\worksheet05_exercise01_solution_translation.json'; corrections = '00_control\SOLUTION05_01_PROTECTED_CORRECTIONS.json' }
)
...
$preparations = @(
    ...
    @('unit-05\lecture05.id.tex', 'lecture05.id.build.tex', 'unit-05\lecture05_prepare.json'),
    @('unit-05\worksheet05.id.tex', 'worksheet05.id.build.tex', 'unit-05\worksheet05_prepare.json'),
    @('unit-05\worksheet05_exercise01_solution.id.tex', 'worksheet05_exercise01_solution.id.build.tex', 'unit-05\worksheet05_exercise01_solution_prepare.json')
)
...
$auxiliaryNames = @(
    'through-unit-05.aux', 'through-unit-05.log', 'through-unit-05.out',
    'through-unit-05.pdf', 'through-unit-05.toc', 'through-unit-05.lof',
    'through-unit-05.fls', 'through-unit-05.fdb_latexmk'
)
...
function Invoke-BuildCycle {
    ...
    $built = Join-Path $buildDir 'through-unit-05.pdf'
...
$inputPaths = @(
    ...
    'build/generated/lecture05.id.build.tex',
    'build/generated/worksheet05.id.build.tex',
    'build/generated/worksheet05_exercise01_solution.id.build.tex',
...
$receipt = [ordered]@{
    schema_version = 1
    workflow = 'o011-through-unit05-pdf-build-v1'
    engine = $engineVersion
    command = 'pdflatex -interaction=nonstopmode -halt-on-error -file-line-error -recorder through-unit-05.tex (three passes per clean cycle; two cycles)'
