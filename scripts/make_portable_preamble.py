...
def main() -> None:
    ...
    replacements = [
        ...
        (r"\renewcommand{\proofname}{\hspace{0cm}{\it Beweis}}", r"\renewcommand{\proofname}{\hspace{0cm}{\it Bukti}}"),
        (
