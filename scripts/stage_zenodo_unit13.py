#!/usr/bin/env python3
"""Stage the seven deterministic, reader-first files for the Unit 13 release."""
...
NOTES_SOURCE_REL = "qa/unit-13/RELEASE_NOTES_20260825.md"
...
NOTES_NAME = "RELEASE_NOTES_20260825.md"
...
DEFAULT_OUTPUT_REL = "output/release-unit13"
DEFAULT_METADATA_REL = "qa/unit-13/ZENODO_METADATA_UNIT13.json"
DEFAULT_RECEIPT_REL = "qa/unit-13/RELEASE_PREPARATION_RECEIPT.json"
...
SCRIPT_PATHS = (
    ...
    "scripts/publish_zenodo_unit13_rdm.py",
    "scripts/stage_zenodo_unit13.py",
...
def copy_source_tree(root: Path, staging: Path, documents: dict[str, Any], gate: dict[str, Any]) -> dict[str, Any]:
    ...
    add_mapping(mapping, "README.md", project_path(root, "qa/unit-13/PACKAGE_README.md"))
    ...
    package_manifest = {
        "schema_version": 1,
        "workflow": "o011-unit13-compact-source-package-v1",
...
def validate_metadata(document: dict[str, Any]) -> None:
    ...
    for required in ("active_partial", "Kuliah 1–13", "Lembar Kerja 1–13"):
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="unit13-release-stage-", dir=output_dir.parent) as temporary_name:
        ...
        receipt = {
            "schema_version": 1,
            "workflow": "o011-prepare-release-unit13-v1",
            "status": "pass",
