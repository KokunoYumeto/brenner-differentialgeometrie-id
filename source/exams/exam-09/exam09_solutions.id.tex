...
\zusatzklammer {[[Kompaktheit/Satz von Heine-Borel/Fakt|Satz von Heine-Borel]]} {} {.} Sebaliknya, garis real $\R$ dan $\R \setminus \{0\}$ tidak kompak karena keduanya merupakan himpunan bagian tak terbatas dari $\R$. Jadi,
