...
Animasi di samping memperlihatkan, sebagai contoh untuk $R=2$, serat-serat bagi berbagai nilai $s$ dalam [[Torus/Faserrealisierung/Andere Fasern/Aufgabe|soal ini]]. Peralihan terjadi pada $s=4=R^2$, atau secara ekuivalen $\sqrt{s}=R$.
[[File:Aufgabe79.27.gif|thumb|Animasi yang memperlihatkan serat-serat fungsi torus pada Soal 11.10 untuk berbagai nilai s.]]
Oleh Lukas Freudenberg. [[Kategorie:Latexseite]]
