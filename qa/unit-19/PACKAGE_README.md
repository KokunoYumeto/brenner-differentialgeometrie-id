# Geometri Diferensial dan Manifold Mulus — paket sumber Unit 19

Paket ini memulihkan batas `active_partial` Kuliah 1–19 dan Lembar Kerja 1–19
dari 29 pasangan inti. Pembaca utama diterbitkan terpisah sebagai PDF A4
terpusat 302 halaman dan arsip HTML semantik yang dapat menyesuaikan lebar
...
- kontrol publik yang tahan kehilangan konteks: tujuan/alur kerja, status,
  ...
  koreksi/adverse;
- sumber Indonesia Unit 1–19, sumber Jerman terurai yang benar-benar dipakai,
...
- artefak pendahulu yang secara eksplisit diperlukan untuk pemeriksaan prefiks
  kumulatif, tanpa menduplikasi pembaca Unit 19 di dalam ZIP sumber;
